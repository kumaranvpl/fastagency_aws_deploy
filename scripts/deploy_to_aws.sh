...
# Variables
export APPLICATION_NAME="fastagency-aws-deploy"
export ENVIRONMENT_NAME="fastagency-aws-deploy-env"
export AWS_REGION=${AWS_REGION:-"eu-central-1"}
export ECR_REPOSITORY="fastagency-aws-deploy"
export BUCKET_NAME="fastagency-aws-deploy"
